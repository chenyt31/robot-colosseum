...
from colosseum import ASSETS_ATOMIC_CONFIGS_FOLDER, ATOMIC_TASKS_PY_FOLDER, ATOMIC_TASKS_TTM_FOLDER
...
@hydra.main(
    config_path=ASSETS_ATOMIC_CONFIGS_FOLDER,
    config_name="basketball_in_hoop.yaml",
    version_base=None,
)
def main(cfg: DictConfig) -> int:
    task_name = cfg.env.task_name
    task_class = name_to_class(task_name, ATOMIC_TASKS_PY_FOLDER)
    ...
    env = EnvironmentExt(
        ...
        headless=False,
        path_task_ttms=ATOMIC_TASKS_TTM_FOLDER,
        env_config=cfg.env,
    )
    env.launch()
