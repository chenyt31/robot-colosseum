...
from colosseum import ASSETS_COMPOSITIONAL_CONFIGS_FOLDER, COMPOSITIONAL_TASKS_PY_FOLDER, COMPOSITIONAL_TASKS_TTM_FOLDER
...
@hydra.main(
    config_path=ASSETS_COMPOSITIONAL_CONFIGS_FOLDER,
    config_name="basketball_in_hoop.yaml",
    version_base=None,
)
def main(cfg: DictConfig) -> int:
    task_name = cfg.env.task_name
    task_class = name_to_class(task_name, COMPOSITIONAL_TASKS_PY_FOLDER)
    ...
    env = EnvironmentExt(
        ...
        headless=False,
        path_task_ttms=COMPOSITIONAL_TASKS_TTM_FOLDER,
        env_config=cfg.env,
    )
    env.launch()
